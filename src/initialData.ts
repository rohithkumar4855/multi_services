...
export const INITIAL_TENANTS: Tenant[] = [
  {
    id: 'tenant-voltfix',
    name: 'SV Power Systems',
    ownerName: 'Srinivasa Rao',
    ownerEmail: 'contact@svpowersystems.in',
    ...
    config: makeConfig(INDUSTRY_PACKS[0], {
      logoText: '⚡ SV Power Systems',
      heroTitle: 'Industrial Electrical Panels & Switchgears',
      heroSubtitle: 'Automatic Power Factor Panels (APFC), 11KV Substations, HT Breakers & Transformers. Manufactured & Commissioned by SV Power Systems.',
      phone: '+91 98480 22338',
      email: 'sales@svpowersystems.in',
      ...
      testimonials: [
        ...
        { id: '3', author: 'Krishna Alloys Nellore', role: 'Director', text: 'Durable and highly reliable HT Breakers. Excellent post-purchase installation support.', rating: 5, service: 'HT Breakers Setup', verified: true },
      ],
    }),
...
export const INITIAL_SERVICES: Service[] = [
  // VoltFix / SV Power Systems (Industrial Electrical Supply & Commissioning)
  {
    id: 'srv-volt-1',
    tenantId: 'tenant-voltfix',
    name: 'HT Breakers Setup',
    category: 'Breakers',
    description: 'Supply and commissioning of High Tension industrial electrical breakers (VCBs/SF6).',
    icon: '⚡',
    basePrice: 45000,
    durationMin: 180,
    emergencyAllowed: true,
    requiredSkills: ['HT Breaker', 'Commissioning'],
    formFields: [{ key: 'rating', type: 'select', label: 'Breaker Rating', required: true, options: ['630A VCB', '1250A VCB', '2000A VCB'] }],
    isActive: true,
    industry: 'Electrical',
    variants: [
      { id: 'v-volt-1-std', name: 'Vacuum Breaker Setup', price: 45000, description: 'Indoor 11KV Vacuum Circuit Breaker commissioning & testing', bookingRule: 'Need Inspection' },
      { id: 'v-volt-1-adv', name: 'SF6 Breaker Commissioning', price: 85000, description: 'Heavy industrial outdoor SF6 breaker gas filling and setup', bookingRule: 'Need Inspection' }
    ]
  },
  {
    id: 'srv-volt-2',
    tenantId: 'tenant-voltfix',
    name: 'APFC Panels Setup',
    category: 'Panels',
    description: 'Automatic Power Factor Correction panels to improve energy efficiency & lower bills.',
    icon: '🔌',
    basePrice: 65000,
    durationMin: 240,
    emergencyAllowed: false,
    requiredSkills: ['APFC Panels', 'Wiring'],
    formFields: [{ key: 'kvar', type: 'number', label: 'Required kVAr Capacity', required: true }],
    isActive: true,
    industry: 'Electrical',
    variants: [
      { id: 'v-volt-2-std', name: '100 kVAr APFC Panel', price: 65000, description: 'Heavy-duty steel panel enclosure with automatic capacitor steps', bookingRule: 'Need Inspection' },
      { id: 'v-volt-2-lux', name: '250 kVAr Custom Panel', price: 145000, description: 'Custom engineered APFC panel with intelligent controller and harmonic filters', bookingRule: 'Need Inspection' }
    ]
  },
  {
    id: 'srv-volt-3',
    tenantId: 'tenant-voltfix',
    name: '11KV Substation Setup',
    category: 'Substations',
    description: 'Complete setup, structural fitting, and grid integration of 11KV substations.',
    icon: '🏗️',
    basePrice: 250000,
    durationMin: 720,
    emergencyAllowed: false,
    requiredSkills: ['Substation', 'High Voltage'],
    formFields: [],
    isActive: true,
    industry: 'Electrical',
    variants: [
      { id: 'v-volt-3-std', name: 'Outdoor Pole Substation', price: 250000, description: 'Rooftop/Pole structure assembly with lightning arresters & cable termination', bookingRule: 'Need Inspection' }
    ]
  },
  {
    id: 'srv-volt-4',
    ...
    description: 'Ranging power and distribution transformers tailored to factory load requirements.',
    icon: '🔋',
    basePrice: 180000,
    durationMin: 360,
    emergencyAllowed: false,
    requiredSkills: ['Transformer', 'Oil Filtration'],
    formFields: [],
    isActive: true,
    industry: 'Electrical',
    variants: [
      { id: 'v-volt-4-std', name: '250 KVA Distribution Transformer', price: 180000, description: 'Copper wound outdoor distribution transformer setup with oil testing', bookingRule: 'Need Inspection' }
    ]
  },
  {
    id: 'srv-volt-5',
    tenantId: 'tenant-voltfix',
    name: 'Armoured Cables & Laying',
    category: 'Cables',
    description: 'Heavy duty XLPE industrial armoured cables laying and termination.',
    icon: '⚡',
    basePrice: 12000,
    durationMin: 120,
    emergencyAllowed: false,
    requiredSkills: ['Cable Laying', 'Termination'],
    formFields: [],
    isActive: true,
    industry: 'Electrical',
    variants: [
      { id: 'v-volt-5-std', name: 'Cable Laying & End Termination', price: 12000, description: 'Up to 95 sq.mm aluminium armoured cable trench routing & glanding', bookingRule: 'Need Inspection' }
    ]
  },
